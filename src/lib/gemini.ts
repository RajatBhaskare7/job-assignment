...
export async function generateCareerCounselingResponse(
  ...
  try {
    ...
    const systemPrompt = `You are a professional career counselor with expertise in career development, job searching, resume building, interview preparation, and professional growth.
